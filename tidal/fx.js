...
(() => {
  ...
  const TRACKS = {
    ...
    18: { arp: [146.83, 174.61, 220.00, 293.66, 349.23, 293.66, 220.00, 174.61], roots: [73.42, 73.42, 87.31, 65.41], step: 200, type: "sawtooth", lp: 1300, gain: 0.09, bass: 0.26 }, // Perihelion III "Ice and Iron" — Dm, heavier sawtooth under a light arp
  };
