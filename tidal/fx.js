...
(() => {
  ...
  const TRACKS = {
    ...
    19: { arp: [155.56, 233.08, 277.18, 311.13, 415.30, 311.13, 277.18, 233.08], roots: [77.78, 77.78, 92.50, 69.30], step: 165, type: "sawtooth", lp: 1700, gain: 0.09, bass: 0.24 }, // Perihelion IV "Sungrazers" — hot D#m, fast and bright
  };
